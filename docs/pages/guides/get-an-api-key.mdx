...
Standard rate limits apply to all API keys. If you need higher limits for production use, [contact us](https://platform.global.church/feedback).
...
- [Named Graph Conventions](/guides/reference/named-graph-conventions) — Understand how data is organized in the knowledge graph.
- [HIS Registries](/guides/reference/his-registries) — Learn about the standard code systems for peoples, languages, religions, and geography.
